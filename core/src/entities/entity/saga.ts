...
>(config: {
  ...
  function* fetchListSaga(action: ReturnType<typeof actions.fetchList>) {
    try {
...
>(config: {
  ...
  function* fetchByIdSaga(action: ReturnType<typeof actions.fetchById>) {
    try {
      const { payload } = action;
...
>(config: {
  ...
  function* fetchDisplayContextSaga(action: ReturnType<typeof actions.fetchDisplayContext>) {
    try {
      const { payload } = action;
...
>(config: {
  ...
  function* fetchEditContextSaga(action: ReturnType<typeof actions.fetchEditContext>) {
    try {
      const { payload } = action;
...
>(config: {
  ...
  function* createSaga(action: ReturnType<typeof actions.create>) {
    try {
      const { payload } = action;
...
>(config: {
  ...
  function* updateSaga(action: ReturnType<typeof actions.update>) {
    try {
      const { payload } = action;
...
>(config: {
  ...
  function* patchSaga(action: ReturnType<typeof actions.patch>) {
    try {
      const { payload } = action;
...
>(config: {
  ...
  function* deleteSaga(action: ReturnType<typeof actions.delete>) {
    try {
      const { payload } = action;
...
>(config: {
  ...
  function* cleanupTransactionSaga(action: ReturnType<typeof actions.cleanupTransaction>) {
    try {
      const { payload } = action;
